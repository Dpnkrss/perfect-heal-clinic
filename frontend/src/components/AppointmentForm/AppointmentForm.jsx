...
const AppointmentForm = () => {
  ...
  return (
    ...
    >
      ...
      <div>
        <form onSubmit={getFormData} className='flex flex-col items-center'>
          ...
          <button
            type='submit'
            className='bg-gray-400  text-white px-4 py-2 rounded-md hover:bg-gray-500 focus:outline-none focus:shadow-outline-white m-2'
          >
            Book Appointment
          </button>
        </form>
